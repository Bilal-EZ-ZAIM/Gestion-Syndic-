...
<?php $__env->startSection('content'); ?>
    <style>
        ...
        .hero-section {
            padding: 30px 0;
            /* Augmenter la valeur de 300px à ce que vous préférez */
    ...
    <div class="row">
        <div class="col-12">
            <div class="hero-section text-center">
                <h1>Page des Résidents</h1>
                <p>Gérez facilement les informations des résidents.</p>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <form class="tablelist-form" autocomplete="off" id="updateForm">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="update-apartment-number-field" class="form-label">Apartment Number</label>
                            <input type="text" name="apartment_number" id="update-apartment-number-field"
                                class="form-control" placeholder="Enter Apartment Number" />
                            <div class="invalid-feedback" id="update-apartment-number-error"></div>
                        </div>
                        <div class="mb-3">
                            <label for="update-phone-field" class="form-label">Phone</label>
                            <input type="text" name="phone" id="update-phone-field" class="form-control"
                                placeholder="Enter Phone Number" />
                            <div class="invalid-feedback" id="update-phone-error"></div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="modal-footer">
...
<?php $__env->startSection('script'); ?>
            ...
            document.getElementById('hoaForms').addEventListener('submit', function(event) {
                ...
                fetch('<?php echo e(route('resdence.store')); ?>', {
                    ...
                    .catch(error => {
                        ...
                        if (error.error === "Apartment number already exists.") {
        ...
        <td>
            <div class="d-flex gap-2">
                <button class="btn btn-sm btn-success edit-item-btn" data-bs-toggle="modal"
                    onclick="openUpdateModal(${item.id}, '${item.name}' , '${item.apartment_number}' , '${item.phone}')">Edit</button>
    ...
    `;
        ...
        function openUpdateModal(id, name, apartmentNumber, phone) {
            document.getElementById('update-name-field').value = name;
            document.getElementById('update-apartment-number-field').value = apartmentNumber;
            document.getElementById('update-phone-field').value = phone;
            ...
            fetch(`<?php echo e(url('/residents')); ?>/${id}`, {
                ...
                .then(data => {
                    ...
                    if (row) {
                        ...
                        row.querySelector('td:nth-child(4)').textContent = data.resident.apartment_number;
                        row.querySelector('td:nth-child(3)').textContent = data.resident.phone;
                    }
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Youcode\Desktop\stafe\Stage\cindik\CindikManager\resources\views/HOA/listResidence.blade.php ENDPATH**/ ?>