            ...
            <div class="modal-content">
                ...
                <form class="tablelist-form" autocomplete="off" id="hoaForms">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="customerphone-field" class="form-label">Phone</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" id="email-field" name="email" id="email-field" class="form-control"
                                placeholder="Enter Email" required />
                            <div class="invalid-feedback" id="email-error"></div>
                        </div>
                        <div class="mb-3">
                            <label for="Password" class="form-label">Password</label>
                            <input type="password" id="Password" name="password" id="password-field"
                                class="form-control" placeholder="Enter Password" required />
                            <div class="invalid-feedback" id="password-error"></div>
                        </div>
                        <div class="mb-3">
                            <label for="imageInput" class="form-label">Image</label>
                            <input type="file" class="form-control" id="imageInput" id="avatar-field"
                                name="avatar">
...
<?php $__env->startSection('script'); ?>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('hoaForms').addEventListener('submit', function(event) {
                ...
                fetch('<?php echo e(route('cindique.store')); ?>', {
                        method: 'POST',
                        headers: {
            ...
            fetch('<?php echo e(route('get.all.Cindique')); ?>')
                .then(response => {
                    if (!response.ok) {
                ...
                .then(data => {
                    if (data.cindique && Array.isArray(data.cindique)) {
                        updateTable(data.cindique);
                    } else {
    ...
    `;
        ...
        function updateRecord(id) {
            ...
            fetch(`<?php echo e(url('/cindique')); ?>/${id}`, {
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    ...
                    // Display success message and update row
                    Swal.fire('Updated!', 'Your record has been updated.', 'success');

                    const row = document.querySelector(`tr[data-id="${id}"]`);
                    if (row) {
                        row.querySelector('td:nth-child(1)').textContent = data.cindique.name;
                    }
        ...
        function deleteRecord(id) {
            fetch(`<?php echo e(url('/getdeleteCindique')); ?>/${id}`, {
                    method: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                    }
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Youcode\Desktop\stafe\Stage\cindik\CindikManager\resources\views/admin/tables-cindique.blade.php ENDPATH**/ ?>